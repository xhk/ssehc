...
class DBHelper:
    ...
    def add_post(self, fid, tid, subject, post, first, last):
        # 获取post id
...
""".format(self.table_prefix, fid, author, authorid, subject, dateline, lastpost, lastposter)
        ...
        for i in range(post_count) :
            ...
            if i == 0 :
                first = 1
                s = subject
            self.add_post(fid, tid, s, post_list[i], first, i==(post_count-1))
