...
function DrawEdit()
{
	...
	var S=('<div style="'+ST1+'margin:3px"><button type="button" style="'+ST0+'width:72px;height:20px;" onclick="save(\'u\');">\u4FDD\u5B58\u68CB\u8C31</button>\u3000<button type="button" style="'+ST0+'width:48px;height:20px;" onclick="preview();">\u9884\u89C8</button>\u3000<button type="button" style="'+ST0+'width:48px;height:20px;" onclick="document.formSave.reset();">\u91CD\u7F6E</button>\u3000<button type="button" style="'+ST0+'width:48px;height:20px;" onclick="Delete(250)">\u5220\u9664</button>\u3000<button type="button" style="'+ST0+'width:48px;height:20px;" onclick="Delete(88)">\u4E22\u5F03</button>\u3000<button type="button" style="'+ST0+'width:116px;height:20px;" onclick="save(\'m\');">\u4FDD\u5B58\u5230\u5927\u5E08\u5BF9\u5C40</button></div>');
	S+=('<div style="'+ST0+'width:438px;height:52px;margin-left:3px;position:relative;"><textarea style="position:absolute;left:0;top:0;width:'+(CSS1?435:438)+'px;height:52px;overflow:hidden;"></textarea>');
	S+=('<div style="'+ST0+'padding:3px 0 0 3px;position:absolute;top:0;left:0;color:#00f">\u3000\u6CE8\u610F\uFF1A\u60A8\u76EE\u524D\u53EF\u4EE5\u9009\u62E9\u5C06\u6700\u65B0<span style="'+ST1+'color:#f00">\u8C61\u68CB\u5927\u8D5B</span>\u6216<span style="'+ST1+'color:#f00">\u540D\u624B\u4E4B\u95F4</span>\u5BF9\u5C40\u68CB\u8C31\u5F55\u5165\u5230\u5927\u5E08\u5BF9\u5C40\u5E93<br>');
	...
	S+=(InputBar('DhtmlXQ_owner','150','\u60A8\u7684\u540D\u79F0')+' \u3000\u60A8\u7684\u5BC6\u7801\uFF1A<input type="password" value="" style="'+ST0+'width:'+(CSS1?146:150)+'px;" name="DhtmlXQ_ownerpass">');
	S+=('<br>'+InputBar('DhtmlXQ_id','150','\u68CB\u8C31\u5E8F\u53F7','g_clearid')+' \u3000' +InputBar('DhtmlXQ_sortid','150','\u6392\u5E8F\u7F16\u53F7'));
	S+=('<br>'+InputBar('DhtmlXQ_title','378','\u68CB\u8C31\u6807\u9898','g_changerbt')+SelectPrev('title'));
	S+=('<div style="'+ST0+'width:438px;height:20px;position:relative;">\u5B9E\u7528\u94FE\u63A5\uFF1A<input type="text" style="'+ST0+'width:'+(CSS1?374:378)+'px;"><div style="'+ST1+'position:absolute;left:63px;top:'+(NS.IE>0&&NS.IE<9?4:2)+'px;"><a href="javascript:g_rbt()" style="'+ST1+'color:#00f">\u63D0\u53D6\u7EA2\u9ED1\u65B9\u8D44\u6599</a> <a href="javascript:g_title()" style="'+ST1+'color:#f00">\u683C\u5F0F\u5316\u6807\u9898</a> <a href="javascript:g_live()" style="'+ST1+'color:00f">\u5C06\u672C\u5C40\u8BBE\u4E3A<span style="'+ST1+'color:f00">\u5BF9\u5C40\u76F4\u64AD</span></a> <a href="javascript:g_hide(\'fastlink.htm#\')" style="'+ST1+'color:#00f">\u67E5\u770B\u9884\u8BBE\u503C</a> <a href="javascript:g_tour()" style="'+ST1+'color:#f00">\u67E5\u5BF9\u9635</a></div></div>');
	S+=(''+InputBar('DhtmlXQ_class','378','\u6240\u5C5E\u5206\u7C7B','g_class')+SelectPrev('class'));
	S+=('<br>'+InputBar('DhtmlXQ_event','378','\u6BD4\u8D5B\u540D\u79F0','g_event')+SelectPrev('event'));
	S+=('<br>'+InputBar('DhtmlXQ_open','378','\u5E03\u5C40\u7C7B\u578B','g_open')+SelectPrev('open'));
	S+=('<br>'+InputBar('DhtmlXQ_refer','378','\u68CB\u8C31\u6765\u6E90','g_refer')+SelectPrev('refer'));
	S+=('<br>'+InputBar('DhtmlXQ_other','301','\u68CB\u8C31\u5907\u6CE8','g_other')+' '+SelectBar('DhtmlXQ_other','71','\u6162\u68CB\u7B2C1\u5C40_\u6162\u68CB\u7B2C2\u5C40_\u6162\u68CB\u7B2C3\u5C40_\u6162\u68CB\u7B2C4\u5C40_\u5FEB\u68CB\u7B2C1\u5C40_\u5FEB\u68CB\u7B2C2\u5C40_\u5FEB\u68CB\u7B2C3\u5C40_\u5FEB\u68CB\u7B2C4\u5C40_\u8D85\u5FEB\u68CB\u7B2C1\u5C40_\u8D85\u5FEB\u68CB\u7B2C2\u5C40_\u52A0\u8D5B\u7B2C1\u5C40_\u52A0\u8D5B\u7B2C2\u5C40_\u52A0\u8D5B\u7B2C3\u5C40_\u52A0\u8D5B\u7B2C4\u5C40_\u9644\u52A0\u8D5B\u7B2C1\u5C40_\u9644\u52A0\u8D5B\u7B2C2\u5C40','\u66F4\u6539')+SelectPrev('other'));
	S+=('<br>'+InputBar('DhtmlXQ_judge','150','\u6267\u53F0\u88C1\u5224')+SelectPrev('judge'));
	S+=(' ' +InputBar('DhtmlXQ_record','150','\u8BB0\u8C31\u4EBA\u5458')+SelectPrev('record'));
	S+=('<br>'+InputBar('DhtmlXQ_remark','150','\u8BC4\u6CE8\u4EBA\u5458')+SelectPrev('remark'));
	S+=(' ' +InputBar('DhtmlXQ_author','150','\u68CB\u8C31\u4F5C\u8005')+SelectPrev('author'));
	S+=('<br>'+InputBar('DhtmlXQ_redteam','150','\u7EA2\u65B9\u56E2\u4F53','g_redteam')+SelectPrev('redteam'));
	S+=(' ' +InputBar('DhtmlXQ_blackteam','150','\u9ED1\u65B9\u56E2\u4F53','g_blackteam')+SelectPrev('blackteam'));
	S+=('<br>'+InputBar('DhtmlXQ_redname','150','\u7EA2\u65B9\u59D3\u540D','g_redname')+SelectPrev('redname'));
	S+=(' ' +InputBar('DhtmlXQ_blackname','150','\u9ED1\u65B9\u59D3\u540D','g_blackname')+SelectPrev('blackname'));
	S+=('<br>'+InputBar('DhtmlXQ_redlevel','150','\u7EA2\u65B9\u7B49\u7EA7','g_redlevel')+SelectPrev('redlevel'));
	S+=(' ' +InputBar('DhtmlXQ_blacklevel','150','\u9ED1\u65B9\u7B49\u7EA7','g_blacklevel'))+SelectPrev('blacklevel');
	S+=('<br>'+InputBar('DhtmlXQ_date','150','\u6BD4\u8D5B\u65E5\u671F','g_date')+SelectPrev('date'));
	S+=(' ' +InputBar('DhtmlXQ_place','150','\u6BD4\u8D5B\u5730\u70B9','g_place')+SelectPrev('place'));
	S+=('<br>'+InputBar('DhtmlXQ_round','73','\u6BD4\u8D5B\u8F6E\u6B21','g_round')+' '+SelectBar('DhtmlXQ_round','71','\u7B2C22\u8F6E_\u7B2C21\u8F6E_\u7B2C20\u8F6E_\u7B2C19\u8F6E_\u7B2C18\u8F6E_\u7B2C17\u8F6E_\u7B2C16\u8F6E_\u7B2C15\u8F6E_\u7B2C14\u8F6E_\u7B2C13\u8F6E_\u7B2C12\u8F6E_\u7B2C11\u8F6E_\u7B2C10\u8F6E_\u7B2C09\u8F6E_\u7B2C08\u8F6E_\u7B2C07\u8F6E_\u7B2C06\u8F6E_\u7B2C05\u8F6E_\u7B2C04\u8F6E_\u7B2C03\u8F6E_\u7B2C02\u8F6E_\u7B2C01\u8F6E_\u51B3\u8D5B_\u534A\u51B3\u8D5B_8\u8FDB4_16\u8FDB8_32\u8FDB16','\u66F4\u6539')+SelectPrev('round'));
	S+=(' ' +InputBar('DhtmlXQ_timerule','73','\u8BB0\u65F6\u89C4\u5219','g_timerule')+' '+SelectBar('DhtmlXQ_timerule','71','1\u5206\u5305\u5E72_3\u5206\u5305\u5E72_5\u5206\u5305\u5E72_10\u5206\u5305\u5E72_30\u5206\u5305\u5E72_40\u5206\u5305\u5E72_45\u5206\u5305\u5E72_60\u5206\u5305\u5E72_5\u5206\uFF0B3\u79D2_10\u5206\uFF0B3\u79D2_10\u5206\uFF0B10\u79D2_40\u5206\uFF0B20\u79D2_60\u5206\uFF0B30\u79D2_\u7EA26\u5206\u9ED14\u5206\uFF0B5\u79D2_10-5-0_30-6-60_30-10-60','\u66F4\u6539')+SelectPrev('timerule'));
	S+=('<br>'+InputBar('DhtmlXQ_group','73','\u6BD4\u8D5B\u7EC4\u522B','g_group')+' '+SelectBar('DhtmlXQ_group','71','\u8D85\u7EA7\u8054\u8D5B_\u7532\u7EA7\u8054\u8D5B_\u5916\u56F4\u8D5B_\u70ED\u8EAB\u8D5B_\u7537\u5B50\u7EC4_\u5973\u5B50\u7EC4_\u7537\u5B50\u7532\u7EC4_\u7537\u5B50\u4E59\u7EC4_\u7537\u5B50\u4E2A\u4EBA_\u5973\u5B50\u4E2A\u4EBA_\u7537\u5B50\u56E2\u4F53_\u5973\u5B50\u56E2\u4F53_\u7537\u5B50A\u7EC4_\u7537\u5B50B\u7EC4_\u7537\u5B50C\u7EC4_\u7537\u5B50D\u7EC4_\u5973\u5B50A\u7EC4_\u5973\u5B50B\u7EC4','\u66F4\u6539')+SelectPrev('group'));
	S+=(' ' +InputBar('DhtmlXQ_table','73','\u6BD4\u8D5B\u53F0\u6B21','g_table')+' '+SelectBar('DhtmlXQ_table','71','\u7B2C20\u53F0_\u7B2C19\u53F0_\u7B2C18\u53F0_\u7B2C17\u53F0_\u7B2C16\u53F0_\u7B2C15\u53F0_\u7B2C14\u53F0_\u7B2C13\u53F0_\u7B2C12\u53F0_\u7B2C11\u53F0_\u7B2C10\u53F0_\u7B2C09\u53F0_\u7B2C08\u53F0_\u7B2C07\u53F0_\u7B2C06\u53F0_\u7B2C05\u53F0_\u7B2C04\u53F0_\u7B2C03\u53F0_\u7B2C02\u53F0_\u7B2C01\u53F0','\u66F4\u6539')+SelectPrev('table'));
	S+=('<br>'+InputBar('DhtmlXQ_type','73','\u68CB\u5C40\u7C7B\u578B')+' '+SelectBar('DhtmlXQ_type','71','\u5168\u5C40_\u5E03\u5C40_\u4E2D\u6B8B\u5C40_\u6392\u5C40_\u6C5F\u6E56\u6B8B\u5C40_\u5B9E\u7528\u6B8B\u5C40_\u5B9E\u6218\u6B8B\u5C40','\u66F4\u6539')+SelectPrev('type'));
	S+=(' ' +InputBar('DhtmlXQ_gametype','73','\u68CB\u5C40\u6027\u8D28')+' '+SelectBar('DhtmlXQ_gametype','71','\u6162\u68CB_\u5FEB\u68CB_\u8D85\u5FEB\u68CB_\u672A\u77E5','\u66F4\u6539')+SelectPrev('gametype'));
	S+=('<br>'+InputBar('DhtmlXQ_result','73','\u5BF9\u5C40\u7ED3\u679C')+' '+SelectBar('DhtmlXQ_result','71','\u9ED1\u80DC_\u548C\u68CB_\u7EA2\u80DC_\u672A\u77E5','\u66F4\u6539')+SelectPrev('result'));
	S+=(' ' +InputBar('DhtmlXQ_endtype','73','\u7ED3\u675F\u65B9\u5F0F')+' '+SelectBar('DhtmlXQ_endtype','71','\u8BA4\u8D1F_\u7EDD\u6740_\u5C40\u65F6_\u8BAE\u548C_\u5224\u548C_\u8BFB\u79D2_\u65AD\u7EBF_\u6B65\u65F6_\u5224\u8D1F_\u56F0\u6BD9_\u653E\u5F03_\u8D85\u65F6_\u53D6\u6D88_\u5C01\u5C40_\u672A\u77E5','\u66F4\u6539')+SelectPrev('endtype'));
	S+=('<br>'+InputBar('DhtmlXQ_redeng','150','\u7EA2\u82F1\u6587\u540D')+SelectPrev('redeng'));
	S+=(' ' +InputBar('DhtmlXQ_blackeng','150','\u9ED1\u82F1\u6587\u540D')+SelectPrev('blackeng'));
	S+=('<br>'+InputBar('DhtmlXQ_redrating','150','\u7EA2\u7B49\u7EA7\u5206')+SelectPrev('redrating'));
	S+=(' ' +InputBar('DhtmlXQ_blackrating','150','\u9ED1\u7B49\u7EA7\u5206')+SelectPrev('blackrating'));
	S+=('<br>'+InputBar('DhtmlXQ_redtime','150','\u7EA2\u65B9\u7528\u65F6')+SelectPrev('redtime'));
	S+=(' ' +InputBar('DhtmlXQ_blacktime','150','\u9ED1\u65B9\u7528\u65F6')+SelectPrev('blacktime'));
	S+=('<br>'+InputBar('DhtmlXQ_price','42','\u68CB\u8C31\u4EF7\u683C'));
	S+=(' ' +InputBar('DhtmlXQ_firstnum','42','\u521D\u59CB\u6B65\u6570'));
	S+=(' \u3000'+InputBar('DhtmlXQ_hidden','73','\u662F\u5426\u516C\u5F00')+' '+SelectBar('DhtmlXQ_hidden','71','\u516C\u5F00_\u4FDD\u5BC6_\u901A\u8FC7','\u66F4\u6539'));
	S+=('<br>'+InputBar('DhtmlXQ_oldowner','150','\u68CB\u8C31\u65E7\u4E3B'));
	S+=(' \u3000'+InputBar('tn','73','\u4FDD\u5B58\u68CB\u5E93')+' '+SelectBar('tn','71','u_m_n'));
	S+=('<br>'+InputBar('DhtmlXQ_binit','378','\u521D\u59CB\u5C40\u9762'));
	S+=('<br><a href="javascript:checkError(\'movelist\')">\u7740\u6CD5\u5E8F\u5217</a>\uFF1A<textarea ondblclick="this.select()" style="'+ST0+'width:'+(CSS1?375:378)+'px;height:88px;overflow-y:scroll;overflow-x:hidden;" name="DhtmlXQ_movelist"></textarea>');
	S+=('<br><a href="javascript:checkError(\'comment\')">\u68CB\u8C31\u6CE8\u89E3</a>\uFF1A<textarea ondblclick="this.select()" style="'+ST0+'width:'+(CSS1?375:378)+'px;height:88px;overflow-y:scroll;overflow-x:hidden;" name="DhtmlXQ_comment"></textarea></form>');
	S+=('<div style="'+ST1+'margin:3px"><button type="button" id="mySaveB" style="'+ST0+'width:72px;height:20px;" onclick="save(\'\');">\u4FDD\u5B58\u68CB\u8C31</button>\u3000<button type="button" style="'+ST0+'width:48px;height:20px;" onclick="preview();">\u9884\u89C8</button>\u3000<button type="button" style="'+ST0+'width:48px;height:20px;" onclick="document.formSave.reset();">\u91CD\u7F6E</button>\u3000<button type="button" style="'+ST0+'width:48px;height:20px;" onclick="Delete(250)">\u5220\u9664</button>\u3000<button type="button" style="'+ST0+'width:48px;height:20px;" onclick="Delete(88)">\u4E22\u5F03</button>\u3000<button type="button" style="'+ST0+'width:116px;height:20px;" onclick="checkError()">\u68C0\u67E5\u7740\u6CD5\u548C\u6CE8\u89E3</button></div>');
	var w=378,h=108,b=4;
	if (NS.IE&&NS.IE<=6) framePrev='<iframe src="" style="width:'+w+'px;height:'+h+';position:absolute;top:0;left:0;border:0;"></iframe>';
	S+=('<div id="prevd0" style="width:'+w+'px;height:'+h+'px;margin-left:63px;position:absolute;background-color:#fff;"><div id="prevIE6" style="width:'+w+'px;height:'+h+';position:absolute;top:0;left:0;overflow:hidden;"></div><textarea style="width:'+(w-(CSS1?3:0))+'px;height:'+h+'px;position:absolute;top:0;left:0;overflow:hidden;"></textarea><div style="position:absolute;top:'+b+'px;left:'+b+'px;height:'+(h-b*2)+'px;width:'+(w-b*2)+'px;overflow-x:hidden;">');
	...
	S+=('<div id="helpdiv" style="'+ST0+'width:438px;height:'+(h+3)+'px;margin-left:3px;position:absolute;"><textarea id="helpTEXTAREA" style="position:absolute;left:0;top:0;width:'+(CSS1?435:438)+'px;height:'+h+'px;overflow:auto;"></textarea><div></div></div>');
...
function g_hide(u,t)
{
	...
	if (document.all) //IE
	{
		if (parent.search_fast.location.href.search(new RegExp(u+'$','gi'))==-1)
		{
			parent.search_fast.location.href=u;
			parent.document.getElementById('search_fast').style.top='0px';
		}
		else
		{
			if (parseInt(parent.document.getElementById('search_fast').style.top)==0&&t!=1)
...
function g_top()
{
	...
	var tr=parent.search_fast.document.getElementById('tb').getElementsByTagName('TR');
	var s=0,u=fasthash.split('#')[1];
	for (i=0;i<tr.length;i++)
	{
		if (tr[i].id!=u) s+=parseInt(tr[i].clientHeight);
		else i=1000;
	}
	parent.search_fast.document.body.scrollTop=s;
}
function g_class()
{
