...
S+=('html {height:100%;}');
S+=('* {font-size:'+fz+'px;line-height:'+lh+'px;margin:0;padding:0;'+((!isBIG5)?'font-family:\u5B8B\u9AD4,\u65B0\u5B8B\u9AD4,"MS Song",SimSun,NSimSun;':'font-family:\u7D30\u660E\u9AD4,\u65B0\u7D30\u660E\u9AD4,MingLiU,PMingLiU;')+'}');
...
function initboard()
{
	...
	s+=cDIV(1,1,bw-2,lh*13+4,0,'line-height:'+lh+'px;background-color:#fff;text-align:center;','','<div style="height:3px;font-size:3px;line-height:3px;"></div><a href="javascript:turnBoard();">\u65CB \u8F49</a><br><a href="javascript:mirrorBoard();">\u5C0D \u7A31</a><br><a href="javascript:EditSave()">\u4FDD \u5B58</a><br><a href="javascript:getUBB();copycode(sText);">\u8907 \u88FD</a><br><a href="javascript:getInfo();">\u4FE1 \u606F</a><br><a href="javascript:Autotimer(8000)">8.0\u79D2</a><br><a href="javascript:Autotimer(5000)">5.0\u79D2</a><br><a href="javascript:Autotimer(3000)">3.0\u79D2</a><br><a href="javascript:Autotimer(2000)">2.0\u79D2</a><br><a href="javascript:Autotimer(1000)">1.0\u79D2</a><br><a href="javascript:Autotimer(500)">0.5\u79D2</a><br><a href="javascript:Autotimer(200)">0.2\u79D2</a><br><a href="javascript:Autotimer(100)">0.1\u79D2</a>');
	s+=('</div></div>');
	// move
	...
	s+=cDIV(6,thh+ch+1,w4-7,'',0,typ,'','<a href="javascript:copycode(sText,0)" style="color:#f00">\u8907\u88FD\u4EE3\u78BC</a> <a href="javascript:setBinit(1)">\u5C07\u5DE6\u5074\u5C40\u9762\u8A2D\u7232\u958B\u59CB</a> <a href="javascript:setBinit(2)" style="color:#f00">\u6E05\u7A7A\u68CB\u76E4</a> <a href="javascript:setBinit(3)">\u65B0\u5C40</a>');
...
{
	var m='\u8907\u88FD\u6210\u529F\uFF0C\u53EF\u7C98\u8CBC\u5C40\u9762\u5230\u8EDF\u4EF6\u4E2D\uFF0C\u6216\u767C\u8868\u68CB\u8B5C\u5230\u7DB2\u7AD9\u8AD6\u58C7\u4E2D';
	...
	else
	{
		...
		else showalert('\u60A8\u7684\u700F\u89BD\u5668\u4E0D\u652F\u6301\u81EA\u52D5\u8907\u88FD\uFF0C\u8ACB\u624B\u52D5\u8907\u88FD');
		return;
        }
	if (!t) showalert(m);
...
function getTEXT(v)
{
	...
	else
	{
		...
		if (temp!=null)
		{
			...
			if (v==1) showalert('<div id="cNumberDIV" style="text-align:center;">\u672C\u68CB\u8B5C['+getvar('title')+']\u5171\u542B'+result.length+'\u500B\u8B8A\u8457\uFF0C\u672C\u6B21\u5C0E\u51FA'+i+'\u500B['+tnum+'\u5C64]\u8B8A\u8457'+((result.length>i)?('\uFF0C\u9084\u6709'+(result.length-i)+'\u500B\u8B8A\u8457\u672A\u80FD\u5C0E\u51FA'):'')+'</div>'+(i>21?'<a href="javascript:getTEXT(2)">\u9EDE\u6B64\u8907\u88FD\u53EF\u7C98\u8CBC\u5230word\u4E2D\u7684\u5E36\u5708\u6578\u5B57\u6587\u672C\uFF0C\u96FB\u8166\u89C0\u770B\u9700\u5B89\u88DDcNumber2\u5B57\u9AD4</a>':''));
		}
		else {tree='';i=100;}
		...
		if (v==2)
		{
			$('cNumberDIV').innerHTML='<iframe style="width:'+(wm*0.8-6)+'px;height:'+(hm-lh-lh-lh-lh-3)+'px;" id="cNumberCOPY" frameborder="1" marginwidth="0" marginheight="0"></iframe><br>'+(NS.IE?'\u8907\u88FD\u6210\u529F\uFF0C\u8ACB\u7ACB\u5373\u7C98\u8CBC\u5230word\u4E2D\u4FDD\u5B58':'\u975EIE\u6838\u5FC3\u700F\u89BD\u5668\uFF0C\u8ACB\u81EA\u5DF1\u52D5\u624B\u8907\u88FD');
...
function getrefer()
{
	...
	var s='<div style="position:absolute;right:0;top:0;text-align:right;width:'+(fz*19+6)+';"><a href="javascript:copysurl()">\u8907\u88FD\u5730\u5740</a>'+((isSP)?' <a href="javascript:digg(1)">\u597D\u8A55</a> <a href="javascript:digg(-1)">\u5DEE\u8A55</a> <a href="javascript:digg(0)">\u5831\u932F</a> <a href="javascript:gEvent()">\u8CFD\u4E8B</a> <a href="javascript:SearchP(\'tree\')">\u8B8A\u8457</a> <a href="javascript:SearchP(\'next\')">\u5C0D\u5C40</a>':'')+'</div>';
	return (s+'<div style="position:absolute;left:0;top:0;overflow:hidden;text-align:left;width:'+(fz*21)+';"><nobr><a href="javascript:getInfo()">\u4F86\u6E90\u7DB2\u7AD9</a>\uFF1A<a href="'+SURL+'gourl.asp?site='+URLEscape(rer)+'&url='+URLEscape(rer)+'" style="color:#000;" target="_blank">'+rer+'</a></nobr></div><br><nobr>\u53C3\u8207\u8A0E\u8AD6\uFF1A<a href="'+SURL+'gourl.asp?site='+URLEscape(rer)+'&url='+URLEscape(rer_url)+'" style="color:#000;" target="_blank">'+rer_url+'</a></nobr>');
}
function gEvent() {}
function copysurl()
{
	...
	if (isSP)
	{
		...
		if (s==null) showalert('\u53EA\u6709\u6771\u840D\u68CB\u8B5C\u5009\u5EAB\u4E2D\u4FDD\u5B58\u7684\u68CB\u8B5C\u624D\u53EF\u8907\u88FD\u5730\u5740');
		else
		{
	...
	if (surl!='')
	{
		...
		sText.value=surl+'\r\n'+t;
		copycode(sText,'\u5DF2\u6210\u529F\u8907\u88FD\u68CB\u8B5C\u5730\u5740\u5230\u526A\u8CBC\u677F\uFF0C\u53EF\u9EDE\u64CA\u4EE5\u4E0B\u7DB2\u5740\u67E5\u770B\u6548\u679C<br><a href="'+(murl?murl:surl)+'" target="_blank" style="color:#00f">'+(murl?murl:surl)+'</a>');
	}
}
function digg(price)
{
